...
export const AboutSection = () => {
  ...
  return (
    <section id="sobre" className="relative noise-texture bg-background py-20 lg:py-[120px]">
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-[5%]">
          ...
          <div className="lg:w-[55%] scroll-reveal">
            ...
            <h2 className="font-display text-4xl lg:text-[48px] font-medium leading-[1.15] mt-4">
              ...
              <br />
              <em className="font-display italic">{t('para um mundo mais justo', 'for a more just world')}</em>
            </h2>
            ...
            <a href="#" className="nav-link-animated font-body text-sm text-tellus-green hover:text-tellus-green-light transition-colors">
              → {t('Conheça a nossa equipa', 'Meet our team')}
            </a>
          </div>
